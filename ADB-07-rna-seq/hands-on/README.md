...
All the links are [clickable](https://gitlab.com/fpozoc/advanced_bioinformatics/-/tree/master/ADB-02-ngs-linux/handson). They contain references, databases and interesting sources to know more about our pipeline.
...
```sh
curl https://gitlab.com/fpozoc/advanced_bioinformatics/-/raw/master/ADB-07-rna-seq/hands-on/data/diff_out_C1_C2.tar.gz -o ~/SAMPLES/diff_out_C1_C2.tar.gz
curl https://gitlab.com/fpozoc/advanced_bioinformatics/-/raw/master/ADB-07-rna-seq/hands-on/data/sample.tar.gz -o ~/SAMPLES/sample.tar.gz
```

and uncompressing:

```sh
tar xf ~/SAMPLES/diff_out_C1_C2.tar.gz
tar xf ~/SAMPLES/sample.tar.gz
```
